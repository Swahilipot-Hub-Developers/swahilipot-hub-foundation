...
const Upcoming = () => {
  ...
  const events = [
    ...
    // },
    {
      ...
      description:
        "Get ready to laugh until your sides hurt at the Mombasa Comedy Show! This event promises an evening filled with laughter, featuring some of the best comedians from across the country. Whether you're a fan of stand-up, improv, or sketch comedy, this show has something for everyone.",
    ...
    // },
    {
      ...
      description:
        'Whisper of Power is a captivating evening that weaves together the enchanting art forms of music, dance, and storytelling. This event celebrates the rich cultural heritage and the profound stories that have shaped our communities, brought to life through powerful performances.',
